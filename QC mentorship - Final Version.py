...
# When we turned the analytics option to off, that means that we do the optimization process with samples, and we can observe that the more samples we use, the more the results will approach to the analytical version.
...
# R = By using the Hermitian Operator. When you use the Hermitian Operator, you have the certainty that the result of the parameter optimization process will be calculated in order to fit the states that you want (In this case a Bell State) and that you have introduced in your A Matrix
